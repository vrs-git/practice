...
$.noty.defaults = {
  layout: 'topRight',
  theme: 'metroui', // or relax ,defaultTheme , metroui , bootstrapTheme
  ...
  template: '<div class="noty_message"><span class="noty_text">yo</span><div class="noty_close"></div></div>',

  timeout: 500, // [integer|boolean] delay for closing event in milliseconds. Set false for sticky notifications
