...
ActiveRecord::Schema.define(version: 20171025115420) do
  ...
  add_index "restraunts", ["email"], name: "index_restraunts_on_email", unique: true
  add_index "restraunts", ["reset_password_token"], name: "index_restraunts_on_reset_password_token", unique: true
